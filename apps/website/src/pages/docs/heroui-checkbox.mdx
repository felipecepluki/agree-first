...
Select the checkbox to see `agree-first` produce a versioned acceptance payload. This is a site-owned visual illustration of a HeroUI-style control, **not** a mounted HeroUI component. The copyable integration code below uses the real component in your app.

<CheckboxIntegrationPreview variant="heroui" client:visible />
