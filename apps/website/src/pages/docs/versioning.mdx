...
import VersioningExample from "../../components/docs/VersioningExample";
import versioningCode from "../../components/docs/VersioningExample.tsx?raw";
...
## Try a version change

The preview starts with a saved Terms v1.3 record. Switch to v1.4 to see the checkbox require acceptance again. Its record stays in this page's memory and is never sent to a server.

<LiveExample title="Versioning & re-acceptance" code={versioningCode}>
  <VersioningExample client:visible />
</LiveExample>
