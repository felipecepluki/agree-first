...
import CheckboxIntegrationPreview from "../../components/docs/CheckboxIntegrationPreview";
...
Select the checkbox to see `agree-first` produce a versioned acceptance payload. This is a site-owned visual illustration of the shadcn-style control, **not** the generated shadcn component. The copyable integration code below uses the real component from your app.

<CheckboxIntegrationPreview variant="shadcn" client:visible />
